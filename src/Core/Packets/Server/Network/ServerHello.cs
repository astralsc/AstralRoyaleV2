...
namespace AstralRoyaleV2.Core.Packets.Server.Network
{
    internal class ServerHello
    {
        ...
        /// <summary>
        /// Creates a new instance of ServerHello.
        /// </summary>
        public ServerHello()
        {
        ...
        /// <summary>
        /// Sends this packet to the client using the provided socket and encrypts it with RC4.
        /// </summary>
        /// <param name="client">Client socket.</param>
        /// <param name="encrypter">RC4 encrypter.</param>
        public void Process(Socket client, RC4 encrypter)
        {
            byte[] encodedPacket = this.Encode();
            MessageHandler.Throw(client, encodedPacket, encrypter);
        }
    }
}